...
x = tf.keras.layers.Dense(4, activation='sigmoid', kernel_initializer='random_normal',
    bias_initializer='random_normal')(inputs)
outputs = tf.keras.layers.Dense(1, activation='sigmoid', kernel_initializer='random_normal',
...
history = model.fit(x=data_x, y=labels, epochs=500)
